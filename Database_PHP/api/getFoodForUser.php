<?php
    ...
    // bữa tối chiếm 25% lượng calo
    $dinner = $calo*25;

    $queryBreakfast="SELECT *FROM foods WHERE (meal='breakfast' and calo<'".$breakfast."') or 
    (meal='snack' and calo<'".$snack."') or (meal='lunch' and calo<'".$lunch."') or (meal='dinner' and calo<'".$dinner."')";
